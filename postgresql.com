...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2021-02-24T03:35:23.456479" />
  ...
  <link href="/media/css/fontawesome.css?8afc748e" rel="stylesheet">
  ...
  <link rel="shortcut icon" href="/favicon.ico" />
    ...
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?8afc748e">
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-february-21-2021-2173/">PostgreSQL Weekly News - February 21, 2021</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-02-22 by PWN</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/dbmigration-net-v134-released-2172/">dbMigration .NET v13.4 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-02-22 by fish&#39;s dotNET</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgbadger-v115-has-been-released-2170/">pgBadger v11.5 has been released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-02-19 by Gilles Darold</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-jdbc-42219-released-2171/">PostgreSQL JDBC 42.2.19 Released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-02-19 by JDBC Project</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgpool-ii-422-416-4013-3718-and-3625-are-now-officially-released-2169/">Pgpool-II 4.2.2, 4.1.6, 4.0.13, 3.7.18 and 3.6.25 are now officially released.</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-02-18 by Pgpool Global Development Group</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/50C"> PostgreSQL Logical Replication Advantage and Step by Step Setup</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Yuwen Fu</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-02-24</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/50B"> PostgreSQL: How to write a trigger</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Hans-Juergen Schoenig</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-02-23</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/50z"> Fuzzy Name Matching in Postgres</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Paul Ramsey</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-02-22</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/50A"> Takayuki Tsunakawa</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/50w"> First Review of Partitioning OpenStreetMap</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Ryan Lambert</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-02-21</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/50v"> Faster data migrations in Postgres</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Sai Srirampur</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-02-20</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/50u"> Query Optimization in Postgres with pg_stat_statements</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Kat Batuigas</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-02-19</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/50t"> explain.depesz.com – now with JITs</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/50s"> Deep PostgreSQL Thoughts: Resistance to Containers is Futile</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Joe Conway</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-02-18</li>
            </ul>
          </div>
        </div>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?8afc748e"></script>
